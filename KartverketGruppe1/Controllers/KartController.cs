...
namespace KartverketGruppe1.Controllers
{
    public class KartController : Controller
    {
        ...
        public async Task<IActionResult> Innmelding(Innmelding innmelding)
        {
            ...
            //[HttpPost]
            //public IActionResult Innmelding(Innmelding innmelding)
            //{
            //    try
            //    {
            //        if (ModelState.IsValid)
            ...
            //                Dato = DateTime.Now, // Setter dagens dato uansett
            //                KommuneID = innmelding.KommuneID,
            //                AvvikstypeID = innmelding.AvvikstypeID,
            //                BrukerID = User.Identity.IsAuthenticated ?
            //                User.FindFirst(ClaimTypes.NameIdentifier)?.Value : null,
            //                Gjest_epost = !User.Identity.IsAuthenticated ?
            //                innmelding.Gjest_epost : null,
            //                StatusID = 1, // Setter alltid til 1 for ny innmelding
            //                KoordinatID = innmelding.KoordinatID,
            //                PrioritetID = 1 // Setter standard prioritet
            //            };
            //            //innmelding = new Innmelding
            //            //{
            //            //    Innmeldingsbeskrivelse = innmelding.Innmeldingsbeskrivelse,
            //            //    Dato = innmelding.Dato,
            //            //    Dokumentasjon = innmelding.Dokumentasjon,
            //            //    KommuneID = innmelding.KommuneID,
            //            //    AvvikstypeID = innmelding.AvvikstypeID,
            //            //    BrukerID = innmelding.BrukerID,
            //            //    Gjest_epost = innmelding.Gjest_epost,
            //            //    StatusID = innmelding.StatusID,
            //            //    KoordinatID = innmelding.KoordinatID,
            //            //    PrioritetID = innmelding.PrioritetID,
            ...
            //    catch (Exception ex)
            //    {
            //        return StatusCode(500, "Kunne ikke lagre koordinat og kommune");
            //    }
            //}
    ...
    //[HttpPost]
    //[ValidateAntiForgeryToken]
    //public async Task<IActionResult> LagreKoordinatOgKommune([FromBody] LagreKoordinatViewModel model)
    //{
    //    try
    //    {
    //        // Sjekk om kommunen allerede finnes
    //        var kommune = await _context.Kommune
    //            .FirstOrDefaultAsync(k => k.Kommunenummer == model.Kommunenummer);

    //        if (kommune == null)
    //        {
    //            // Opprett ny kommune hvis den ikke finnes
    //            kommune = new Kommune
    //            {
    //                Kommunenummer = model.Kommunenummer,
    //                Kommunenavn = model.Kommunenavn
    ...
    //    {
    //        _logger?.LogError(ex, "Feil ved lagring av koordinat og kommune");
    //        return StatusCode(500, "Kunne ikke lagre posisjonen");
    //    }
    //}

    //// Legg til denne ViewModel-klassen i samme fil eller i egen fil
    //public class LagreKoordinatViewModel
    //{
    //    public double Latitude { get; set; }
    //    public double Longitude { get; set; }
